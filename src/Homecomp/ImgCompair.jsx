...
const ImgCompair = () => {
  return (
    <div className="m-auto w-full h-screen bg-zinc-100 text-6xl flex flex-col items-center">
        ...
        <div className='m-auto w-[80%] h-[50%] flex justify-between gap-[100px] p-0 mt-[-10vh]'>
            ...
            />
            <ReactCompareSlider className='w-[80%] border-8 border-amber-500 rounded-3xl overflow-hidden'
                itemOne={<ReactCompareSliderImage src={img21} srcSet={img21} alt="Image one" />}
                itemTwo={<ReactCompareSliderImage src={img22} srcSet={img22} alt="Image two" />}
            />
        </div>
    </div>
  )
