...
const OurServices = () => {
  ...
  return (
    <div className="w-full relative">
        <div className="flex flex-col justify-center items-center m-auto pt-[20vh] pb-[5vh]">
                ...
                {elem1.map((item,index)=>{
                     return <div key={index} className="elem w-full h-[20vh] flex flex-row justify-between mt-5 border-2 px-[10px]">
                                <div className="flex justify-center">
                                     <img data-scroll data-scroll-speed="-.5" className="w-[50px] object-contain" src={item.img} alt="" />
                                </div>
